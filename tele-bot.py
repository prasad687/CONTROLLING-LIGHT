...
ADAFRUIT_IO_USERNAME = os.getenv('prasad1011')
ADAFRUIT_IO_KEY = os.getenv('aio_fhbi05R7gUsuY3OzWWbgW4gn3i7F')
TOKEN = os.getenv('1162688820:AAHztmWaIeMviAnfZ6ApztfbzqdMITczvhE')
...
updater =Updater('1162688820:AAHztmWaIeMviAnfZ6ApztfbzqdMITczvhE')
